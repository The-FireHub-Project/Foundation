...
/**
 * ### Provides an initialization strategy based on a generator callback
 *
 * Generator callback initializer creates a new generator for each initialization request, allowing the initial
 * contents of a storage to be produced lazily without retaining a single-use generator instance.
 *
 ...
 */
final readonly class GeneratorCallbackInit implements Initializer {
