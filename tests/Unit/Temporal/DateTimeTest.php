...
final class DateTimeTest extends FireHubTestCase {
    ...
    public function testFrom (string $expected, string $value, Zone $zone = Zone::UTC):void {

        self::assertSame($expected, DateTime::from($value, $zone)->value());
    ...
    public function testFromFormat (string $expected, string $value, string|Format $format = Format::ISO_DATE_TIME, Zone $zone = Zone::UTC):void {

        self::assertSame($expected, DateTime::fromFormat($value, $format, $zone)->value());
